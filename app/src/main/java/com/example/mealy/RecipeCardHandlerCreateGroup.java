...
public class RecipeCardHandlerCreateGroup {
    ...
    public RecipeCardHandlerCreateGroup(Context context, Recipe recipe, SwipePlaceHolderView swipeView) throws JSONException {
    ...
    private void onSwipedOut() {
        ...
        for (int i = 0; i < ActivityCreateGroup.mResolvers.size(); i++) {
            if (ActivityCreateGroup.mResolvers.get(i) == tmp.get(0)) {
                ActivityCreateGroup.mDislikedIDs.add(ActivityCreateGroup.mStackIDs.get(i));
            }
        }
    }
    ...
    private void onSwipeIn() {
        ...
        for (int i = 0; i < ActivityCreateGroup.mResolvers.size(); i++) {
            if (ActivityCreateGroup.mResolvers.get(i) == tmp.get(0)) {
                ActivityCreateGroup.mLikedIDs.add(ActivityCreateGroup.mStackIDs.get(i));
            }
        }
    }
